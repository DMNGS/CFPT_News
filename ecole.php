...
<html>
    ...
    <body>
        ...
        <?php include 'nav.php' ?>
        <section>
            <h2>Voici la page avec les articles sur les nouvelles de l'École!</h2>
            <?php
            echo "<p>" . file_get_contents("./tmp/Article Ecole 1.txt") . "</p>"; // get the contents, and echo it out.
            echo "<p>" . file_get_contents("./tmp/Article Ecole 2.txt") . "</p>"; // get the contents, and echo it out.
            echo "<p>" . file_get_contents("./tmp/Article Ecole 3.txt"). "</p>";
            ?>
        </section>
